...
/* Additional RTL support for all select elements */
.select-content {
  direction: rtl;
}
...
/* Ensure Select components have exact same size as input fields */
[data-radix-select-trigger] {
...
/* Override any default Select styling to match input fields */
